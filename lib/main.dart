import 'package:bruno/bruno.dart' deferred as bruno;
...
import 'package:work_calendar/app.dart' deferred as app;
import 'package:work_calendar/controller/calendar_controller.dart'
    deferred as calendar_controller hide WorkTypeString;
import 'package:work_calendar/work_selection_page.dart'
    deferred as work_selection_page;

late Future<String?> f;
bool notified = false;

Future<void> loadLibraries() async {
  await bruno.loadLibrary();
  await app.loadLibrary();
  await calendar_controller.loadLibrary();
  await work_selection_page.loadLibrary();
}

void main() async {
  WidgetsFlutterBinding.ensureInitialized();
  await loadLibraries();
  f = calendar_controller.initTools();
  bruno.BrnInitializer.register(
      allThemeConfig: bruno.BrnAllThemeConfig(
          commonConfig: bruno.BrnCommonConfig(brandPrimary: Colors.black)));
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        // '/': (context) => MyApp(),
        '/work_selection': (context) => work_selection_page.WorkSelectionPage(),
      },
      home: app.MyHomePage(),
      initialRoute: "/",
